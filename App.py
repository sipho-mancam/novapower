...
def index_data():
    ...
    solar_packages = { 
        "package 0":{
            'items':[{
                ...
                "size":{
                    ...
                    "Voltage":{"unit":"V", "value":24},
                    "Power":{"unit":"kW", "value":3},
                    
                },
                "image_url":"https://i.ibb.co/Dw8shxf/Microsoft-Teams-image.jpg",
        ...
        "package 1":{
            'items':[{
                "brand":"Power Inverter",
                "name":"Inverter",
                "package-flag":False,
                "package-group":"Inverters",
                "size":{
                    "Size":{"unit":"kVA", "value": 3},
                    "Voltage":{"unit":"V", "value":12},
                    "Power":{"unit":"kW", "value":3},
